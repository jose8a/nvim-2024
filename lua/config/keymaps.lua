...
vim.keymap.set({ "n", "v" }, "<LocalLeader>ci", "<cmd>CodeCompanion<cr>", { noremap = true, silent = true })
vim.keymap.set({ "n" }, "<LocalLeader>cl", "<cmd>CodeCompanionCmd<cr>", { noremap = true, silent = true })
